	...
	public Help() {
		...
		btnOkay.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent arg0) {
				btnOkay.setIcon(new ImageIcon(Help.class.getResource("/mathsteroid/resources/menu/btn_exit_hover.png")));
			}
			@Override
			public void mouseExited(MouseEvent arg0) {
				btnOkay.setIcon(new ImageIcon(Help.class.getResource("/mathsteroid/resources/menu/btn_exit.png")));
			}
		});
		btnOkay.setIcon(new ImageIcon(Help.class.getResource("/mathsteroid/resources/menu/btn_exit.png")));
		...
		label.setIcon(new ImageIcon(Help.class.getResource("/mathsteroid/resources/menu/bg_help.png")));
